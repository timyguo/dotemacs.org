#+TITLE: dotemacs boiler plate
#+AUTHOR: Tony Day
#+EMAIL: tonyday567 at gmail dot com
#+COLUMNS: %25ITEM %30tangle
#+PROPERTIES: tangle yes

A simplified version.  Especially useful for early stage bootstrap
testing.
...
- is as flat a structure as possible
- is opinionated as to what should be added (mostly according to
  questionable author tastes)
- is predominantly a fork of jwiegley's .emacs, especially use-package and bind
** flow 
