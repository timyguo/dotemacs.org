...
side of the window.  This drastic setting was what I needed to prevent that.")
 ...
 '(yas/snippet-dirs (quote ("~/.emacs.d/snippets" "/Users/tonyday/.emacs.d/repos/jwiegley/site-lisp/yasnippet/snippets")) nil (yasnippet))
...
(custom-set-faces
 ...
 '(message-header-name ((t (:foreground "headerColor" :weight normal))))
 '(message-header-other ((t (:foreground "headerColor"))))
 '(message-header-subject ((t (:foreground "controlLightHighlightColor" :weight bold))))
 '(message-header-xheader ((t (:foreground "headerColor"))))
