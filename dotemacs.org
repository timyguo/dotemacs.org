...
#+end_src
*** TODO gnus
Need to get offlineimap working so turning on gnus is fast.
...
#+begin_src emacs-lisp
    ;; disabling news agent so that catchup works
  (setq gnus-agent nil)
...
#+results:
| nnimap | scarce | (nnimap-address imap.gmail.com) | (nnimap-server-port 993) | (nnimap-stream ssl) | (nnimap-user tony.day@scarcecapital.com) |
...
| stuff    | quant   | da.org                     |
| stuff    | sys     | git.org                    |
| stuff    | site    | scarcecapital.com.org      |
| stuff    | site    | mindev.org                 |
