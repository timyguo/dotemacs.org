...
** random tasks
- [X] remove properties folders
- [X] separate org stuff
- [X] get key-binds done
- [X] clean up existing packages
- [ ] clean up settings
...
|--------------------------------------+--------|
| ~/.emacs.d                           | t      |
| ~/.emacs.d/src/org-mode/contrib/lisp | t      |
...
- [ ] sorting out inter-dependent problems with ido and dired.

state 1
dired off, ido on

C-x C-f bound to find-file and not ido-find-file
running ido-find-file produces an error:

ls does not support --dired; see `dired-use-ls-dired' for more details.
dired-use-ls-dired is nil
